            ...
            <div className="cart">
                <div className="cart__top">
                    ...
                    <div className="cart__clear">
                        ...
                        <span>Clear cart</span></div>
                </div>
                <div className="content__items">
                    <div className="cart__item">
                        <div className="cart__item-img">
                            <img className="paintings-block__image"
                                 src=""
                                 alt="drawings"/></div>
                        <div className="cart__item-info"><h3>Alcantara</h3><p>M</p></div>
                        ...
                        <div className="cart__item-price"><b>130$</b></div>
                    ...
                    <div className="cart__item">
                        <div className="cart__item-img">
                            <img className="paintings-block__image"
                                 src=""
                                 alt="drawings"/></div>
                        <div className="cart__item-info"><h3>Paradise</h3><p>S</p></div>
                        <div className="cart__item-count">
                            <button className="button button--outline button--circle cart__item-count-minus">
                                <svg width="10" height="10" viewBox="0 0 10 10" fill="none"
                                     xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div className="cart__item-price"><b>140$</b></div>
                        <div className="cart__item-remove">
                            <div className="button button--outline button--circle">
                                <svg width="10" height="10" viewBox="0 0 10 10" fill="none"
                                     xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="cart__bottom">
                    <div className="cart__bottom-details">
                        <span> Total: <b>2pcs.</b> </span>
                        <span> Total price: <b>260$</b> </span>
                    </div>
                    <div className="cart__bottom-buttons">
                        ...
                        <div className="button pay-btn"><span>Pay now</span></div>
                    </div>
                </div>
            </div>
        </div>
